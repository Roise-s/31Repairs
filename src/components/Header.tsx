    ...
    <div>
        ...
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="/" className="flex items-center space-x-3 rtl:space-x-reverse">
                ...
                <span className="self-center text-2xl font-medium whitespace-nowrap dark:text-white">31 Repairs</span>
            </a>
            ...
            <div className="hidden w-full md:block md:w-auto mr-32" id="navbar-default">
