...
const HeroSection = () => {
  return (
    <div className="max-w-[85rem] mx-auto h-screen px-4 lg:mt-12 sm:px-6 lg:px-8">
    {/* Grid */}
    <div className="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
        <div>
        <h1 className="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight">Fast, reliable repair with <span className="text-blue-600">31 Repairs</span></h1>
        <p className="mt-3 text-lg text-gray-800">Your trusted partner for fast, affordable, and professional phone repair. Keeping your phone in top shape so you're never out of touch.</p>
        ...
        <img className="w-full rounded-md h-11/12" src="/HorePic.jpg" alt="Hero Image" />
